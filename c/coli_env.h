...
static const ColiEnvVar coli_env_table[] = {
    ...
    {"COLI_ANS_DIRECT",                 CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_ANS_PACK",                   CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_ANS_PROFILE",                CE_STR   , CE_ALL     , 0             , NULL},
    {"COLI_ANS_SIDECAR",                CE_STR   , CE_ALL     , 0             , NULL},
    {"COLI_CORPUS_K",                   CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_CORPUS_MINACC",              CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_CUDA",                       CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_CUDA_ASYNC",                 CE_INT   , CE_ALL     , 0             , NULL},
    ...
    {"COLI_CUDA_DUAL_PROJ",             CE_INT   , CE_ALL     , 0             , NULL},
    ...
    {"COLI_CUDA_PROFILE",               CE_INT   , CE_ALL     , 0             , NULL},
    ...
    {"COLI_CUDA_TC_INT4",               CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_CUDA_TC_MIN_ROWS",           CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_CUDA_TC_W4A16",              CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_CUDA_TC_W4A16_MIN",          CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_CUDA_W4_PACKED",             CE_INT   , CE_ALL     , 0             , NULL},
    {"COLI_DISKCLASS_WINDOW",           CE_STR   , CE_COLIBRI , 0             , NULL},
    {"COLI_DISK_WEIGHTS",               CE_STR   , CE_COLIBRI , 0             , NULL},
    {"COLI_DRAFT_CORPUS",               CE_STR   , CE_COLIBRI , 0             , NULL},
    {"COLI_DSA_GATHER",                 CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_ENV_DUMP",                   CE_BOOL  , CE_ALL     , 0             , NULL},
    {"COLI_ENV_STRICT",                 CE_BOOL  , CE_ALL     , 0             , NULL},
    {"COLI_GEMM_CHUNK",                 CE_STR   , CE_ALL     , 0             , NULL},
    {"COLI_GPU",                        CE_STR   , CE_COLIBRI , 0             , NULL},
    {"COLI_GPUS",                       CE_STR   , CE_COLIBRI , 0             , NULL},
    {"COLI_GPU_FAIL_AFTER",             CE_STR   , CE_ALL     , 0             , NULL},
    {"COLI_GROUP_ASYNC",                CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_KV_SHARE",                   CE_INT   , CE_COLIBRI , 0             , NULL},
    {"COLI_LOGIT_DUMP",                 CE_STR   , CE_ALL     , 0             , NULL},
    {"COLI_METAL",                      CE_INT   , CE_ALL     , 0             , NULL},
    ...
    {"NGEN",                            CE_INT   , CE_COLIBRI , 0             , NULL},
    {"NOGPU",                           CE_STR   , CE_INKLING , 0             , NULL},
    {"NOPACK",                          CE_STR   , CE_COLIBRI , 0             , NULL},
    {"NUCLEUS",                         CE_FLOAT , CE_ALL     , 0             , NULL},
    {"OMP_NUM_THREADS",                 CE_STR   , CE_ALL     , 0             , NULL},
    {"PILOT",                           CE_INT   , CE_ALL     , 0             , NULL},
    {"PILOT_EVICT_GUARD",               CE_INT   , CE_ALL     , 0             , NULL},
    ...
    {"PPL",                             CE_INT   , CE_OLMOE   , 0             , NULL},
    {"PREFETCH",                        CE_INT   , CE_COLIBRI , 0             , NULL},
    {"PROF",                            CE_INT   , CE_COLIBRI , 0             , NULL},
    {"PROMPT",                          CE_STR   , CE_COLIBRI , 0             , NULL},
    {"RAM_GB",                          CE_FLOAT , CE_COLIBRI , 0             , NULL},
    ...
    {"SEED",                            CE_INT   , CE_ALL     , 0             , NULL},
    {"SERVE",                           CE_INT   , CE_ALL     , 0             , NULL},
    {"SERVE_BATCH",                     CE_INT   , CE_ALL     , 0             , NULL},
    {"SMOOTH",                          CE_FLOAT , CE_OLMOE   , 0             , NULL},
    {"SNAP",                            CE_STR   , CE_ALL     , 0             , NULL},
    {"SNAP_MIRROR",                     CE_STR   , CE_COLIBRI , 0             , NULL},
    {"SPEC",                            CE_INT   , CE_COLIBRI , 0             , NULL},
    {"SPEC_PIN",                        CE_INT   , CE_COLIBRI , 0             , NULL},
    {"STATS",                           CE_STR   , CE_COLIBRI , 0             , NULL},
    {"TEMP",                            CE_FLOAT , CE_ALL     , CE_DEPRECATED , "COLI_TEMP"},
    {"TF",                              CE_STR   , CE_COLIBRI , 0             , NULL},
    {"THINK",                           CE_INT   , CE_ALL     , 0             , NULL},
...
static int coli_env_check(unsigned char self, const char *name) {
    ...
    for (char **e = envp; e && *e; e++) {
        ...
        if (!(v->engines & self)) {
            fprintf(stderr, "[env] %s is not read by %s (it belongs to %s%s%s%s) -- it will have no effect\n",
                    key, name,
