...
int main(void){
    ...
    if(!single_cache||!single_in||!single_out||!single||!dsv4_cuda_activation_upload(single_in,x,H)||
       !dsv4_cuda_attention_sparse_batch(single_in,an,qkv,qn,qb,kvn,sink,HEADS,K,0,1,1e-6f,single_cache,single_out)||
