...
class ResourcePlanTest(unittest.TestCase):
    ...
    def test_native_memory_available_is_positive(self):
...
"""
    ...
    def test_native_probe_smoke(self):
        ...
        # A Nix Darwin build sandbox is not a native-host probe. The hermetic
        # parser/command cases above stay active there; this smoke remains in
        # the native macOS job and on developer Macs.
