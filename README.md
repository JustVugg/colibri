...
| **GLM-5.3-Flash** (Z.ai) | 321B / 40B | [`zai-org/GLM-5.3-Flash`](https://huggingface.co/zai-org/GLM-5.3-Flash) — converted to **int4-gs64** routed experts, dense stays BF16 and the precision is a load-time choice; vision included | `make -C c glm53` (CPU) or `make -C c glm53 HIP=1 HIP_ARCH=gfxXXXX` (full device-resident text pipeline) | [glm53-flash.md](docs/glm53-flash.md) |
